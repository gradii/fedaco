...
export function mixinHasTimestamps<T extends Constructor<any>>(base: T): HasTimestampsCtor & T {
  ...
  return class _Self extends base {
    ...
    public GetCreatedAtColumn() {
      return 'CREATED_AT' in (this.constructor as any) ? (this.constructor as any).CREATED_AT : 'created_at';
    }

    /* Get the name of the "updated at" column. */
    public GetUpdatedAtColumn() {
      return 'UPDATED_AT' in (this.constructor as any) ? (this.constructor as any).UPDATED_AT : 'updated_at';
    }
