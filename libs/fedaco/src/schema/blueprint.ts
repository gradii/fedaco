 ...
 */
import { has, isAnyEmpty, isArray, isBlank, isString, lowerFirst, upperFirst } from '@gradii/nanofn';
...
export class Blueprint {
  ...
  public constructor(table: string, callback: (blueprint: Blueprint) => void | null = null, prefix = '') {
    this.table = table;
    this.prefix = prefix;
    if (!isBlank(callback)) {
      callback(this);
  ...
  public dropSoftDeletes(column = 'deleted_at') {
    this.dropColumn(column);
  }

  /* Indicate that the soft delete column should be dropped. */
  public dropSoftDeletesTz(column = 'deleted_at') {
  ...
  public primary(columns: any[] | string, name: string | null = null, algorithm: string | null = null) {
    return this.indexCommand('primary', columns, name, algorithm);
  }

  /* Specify a unique index for the table. */
  public unique(columns: any[] | string, name: string | null = null, algorithm: string | null = null) {
    return this.indexCommand('unique', columns, name, algorithm);
  }

  /* Specify an index for the table. */
  public index(columns: any[] | string, name: string | null = null, algorithm: string | null = null) {
  ...
  public foreign(columns: any[] | string, name: string | null = null) {
    const command = new ForeignKeyDefinition(this.indexCommand('foreign', columns, name).getAttributes());
  ...
  public integer(column: string, autoIncrement = false, unsigned = false) {
    return this.addColumn('integer', column, { autoIncrement, unsigned });
  }

  /* Create a new tiny integer (1-byte) column on the table. */
  public tinyInteger(column: string, autoIncrement = false, unsigned = false) {
    return this.addColumn('tinyInteger', column, { autoIncrement, unsigned });
  }

  /* Create a new small integer (2-byte) column on the table. */
  public smallInteger(column: string, autoIncrement = false, unsigned = false) {
    return this.addColumn('smallInteger', column, { autoIncrement, unsigned });
  }

  /* Create a new medium integer (3-byte) column on the table. */
  public mediumInteger(column: string, autoIncrement = false, unsigned = false) {
    return this.addColumn('mediumInteger', column, { autoIncrement, unsigned });
  }

  /* Create a new big integer (8-byte) column on the table. */
  public bigInteger(column: string, autoIncrement = false, unsigned = false) {
    return this.addColumn('bigInteger', column, { autoIncrement, unsigned });
  }

  /* Create a new unsigned integer (4-byte) column on the table. */
  public unsignedInteger(column: string, autoIncrement = false) {
    return this.integer(column, autoIncrement, true);
  }

  /* Create a new unsigned tiny integer (1-byte) column on the table. */
  public unsignedTinyInteger(column: string, autoIncrement = false) {
    return this.tinyInteger(column, autoIncrement, true);
  }

  /* Create a new unsigned small integer (2-byte) column on the table. */
  public unsignedSmallInteger(column: string, autoIncrement = false) {
    return this.smallInteger(column, autoIncrement, true);
  }

  /* Create a new unsigned medium integer (3-byte) column on the table. */
  public unsignedMediumInteger(column: string, autoIncrement = false) {
    return this.mediumInteger(column, autoIncrement, true);
  }

  /* Create a new unsigned big integer (8-byte) column on the table. */
  public unsignedBigInteger(column: string, autoIncrement = false) {
  ...
  public unsignedDecimal(column: string, total = 8, places = 2) {
  ...
  public softDeletes(column = 'deleted_at', precision = 0) {
    return this.timestamp(column, precision).withNullable();
  }

  /* Add a "deleted at" timestampTz for the table. */
  public softDeletesTz(column = 'deleted_at', precision = 0) {
  ...
  public ipAddress(column = 'ip_address') {
    return this.addColumn('ipAddress', column);
  }

  /* Create a new MAC address column on the table. */
  public macAddress(column = 'mac_address') {
  ...
  protected indexCommand(type: string, columns: any[] | any, index: string, algorithm: string | null = null) {
