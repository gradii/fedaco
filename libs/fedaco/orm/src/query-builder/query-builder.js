...
import { isAnyEmpty, isArray, isBlank, isBoolean, isFunction, isNumber, isString } from '@gradii/check-type';
...
export class QueryBuilder extends Builder {
  ...
  _selectAs(columns, as) {
    if (arguments.length === 2) {
      ...
      this._columns.push(new ColumnReferenceExpression(new PathExpression([createIdentifier(columns)]), createIdentifier(as)));
    } else {
  ...
  pluck(column, key) {
    return __awaiter(this, void 0, void 0, function* () {
      const queryResult = yield this.onceWithColumns(isBlank(key) ? [column] : [column, key], () => __awaiter(this, void 0, void 0, function* () {
  ...
  distinct(...args) {
    const columns = args;
    if (columns.length > 0) {
      this._distinct = isArray(columns[0]) || isBoolean(columns[0]) ? columns[0] : columns;
    } else {
      this._distinct = true;
    }
    return this;
  ...
  insertGetId(values, sequence = 'id') {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return this._processor.processInsertGetId(this, sql, this.getBindings(), sequence);
    });
  }
  ...
  get(columns = ['*']) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return yield this.onceWithColumns(columns, () => __awaiter(this, void 0, void 0, function* () {
        return this._processor.processSelect(this, yield this.runSelect());
      }));
    });
  }
  ...
  insertUsing(columns, query) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return this._connection.affectingStatement(this._grammar.compileInsertUsing(this, columns, node), this.getBindings());
    });
  }
  ...
  insertOrIgnore(values) {
    ...
    return this._connection.affectingStatement(this._grammar.compileInsertOrIgnore(this, values), this.getBindings()
    );
  }
  ...
  runSelect() {
    return __awaiter(this, void 0, void 0, function* () {
      return this._connection.select(this.toSql(), this.getBindings(), !this._useWriteConnection);
    });
  }
  ...
  increment(column, amount = 1, extra = []) {
    ...
    const columns = Object.assign({ [column]: raw(`${wrapped} + ${amount}`) }, extra);
  ...
  delete(id) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!isBlank(id)) {
        this.addWhere(new ComparisonPredicateExpression(new ColumnReferenceExpression(new PathExpression([
          this._from,
          createIdentifier('id')
        ])), '=', bindingVariable(id)));
      }
      return this._connection.delete(this._grammar.compileDelete(this), this.getBindings());
    });
  }
  ...
  updateOrInsert(attributes, values = {}) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!(yield this.where(attributes).exists())) {
        return yield this.insert(Object.assign(Object.assign({}, attributes), values));
      }
      if (isAnyEmpty(values)) {
        return true;
      }
  ...
  upsert(values, uniqueBy, update = null) {
    ...
    return this._connection.affectingStatement(this._grammar.compileUpsert(this, values, uniqueBy, update), this.getBindings());
  }
  ...
  insert(values) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return this._connection.insert(this._grammar.compileInsert(this, values), this.getBindings()
      );
    });
  }
  ...
  selectSub(query, as) {
    ...
    return this._columns.push(new ColumnReferenceExpression(this._createSubQuery('select', query), columnAsNode));
  }
