...
export function mixinWhereCommon(base) {
  return class _Self extends base {
    ...
    whereColumn(first, operator, second, conjunction = 'and') {
      ...
      this.addWhere(new ComparisonPredicateExpression(leftNode, operator, rightNode), conjunction);
      return this;
    }
    ...
    whereRaw(sql, bindings = [], conjunction = 'and') {
      this.addWhere(new RawBindingExpression(new RawExpression(sql), bindings.map(it => {
