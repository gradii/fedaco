...
export function camelCase(input, options = {}) {
  return pascalCase(
    input,
    Object.assign({ transform: camelCaseTransform }, options)
  )
}
...
export function capitalCase(input, options = {}) {
  return noCase(
    input,
    Object.assign({ delimiter: ' ', transform: capitalCaseTransform }, options)
  )
}
export function constantCase(input, options = {}) {
  return noCase(
    input,
    Object.assign({ delimiter: '_', transform: upperCase }, options)
  )
}
...
export function pascalCase(input, options = {}) {
  return noCase(
    input,
    Object.assign({ delimiter: '', transform: pascalCaseTransform }, options)
  )
}
...
export function sentenceCase(input, options = {}) {
  return noCase(
    input,
    Object.assign({ delimiter: ' ', transform: sentenceCaseTransform }, options)
  )
}
...
export function replaceArray(subject, search, replaces) {
  ...
  for (const segment of segments) {
    result +=
      ((_a = replaces.shift()) !== null && _a !== void 0 ? _a : search) +
      segment
  }
  return result
}
