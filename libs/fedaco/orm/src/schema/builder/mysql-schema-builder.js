...
export class MysqlSchemaBuilder extends SchemaBuilder {
  ...
  hasTable(table) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const result = yield this.connection.select(this.grammar.compileTableExists(), [this.connection.getDatabaseName(), table]);
  ...
  getColumnListing(table) {
    return __awaiter(this, void 0, void 0, function* () {
      table = this.connection.getTablePrefix() + table;
      const results = yield this.connection.select(this.grammar.compileColumnListing(), [this.connection.getDatabaseName(), table]);
