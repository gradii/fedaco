...
export class SchemaBuilder {
  ...
  static defaultMorphKeyType(type) {
    if (!['int', 'uuid'].includes(type)) {
      throw new Error(
        `InvalidArgumentException Morph key type must be 'int' or 'uuid'.`
      )
    }
  ...
  hasTable(table) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const result = yield this.connection.selectFromWriteConnection(
  ...
  getColumnListing(table) {
    return __awaiter(this, void 0, void 0, function* () {
      const results = yield this.connection.selectFromWriteConnection(
  ...
  dropAllViews() {
    throw new Error(
      'LogicException This database driver does not support dropping all views.'
    )
  }

  dropAllTypes() {
    throw new Error(
      'LogicException This database driver does not support dropping all types.'
    )
  }

  getAllTables() {
    throw new Error(
      'LogicException This database driver does not support getting all tables.'
    )
  }
  ...
  _getPortableTableIndexesList(tableIndexRows, tableName = null) {
    ...
    for (const tableIndex of tableIndexRows) {
      ...
      result[keyName]['options']['lengths'].push(
        (_b = tableIndex['length']) !== null && _b !== void 0 ? _b : null
      )
    }
  ...
  listTableIndexes(table) {
    return __awaiter(this, void 0, void 0, function* () {
      const sql = this.grammar.getListTableIndexesSQL(
        table,
  ...
  tablesExist(tableNames) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return (
        ...
        intersection(
          tableNames,
          (yield this.listTableNames()).map((it) => it.toLowerCase())
        ).length
      )
    })
  }
