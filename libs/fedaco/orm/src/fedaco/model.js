...
export class Model extends mixinHasAttributes(
  mixinHasEvents(
    mixinHasGlobalScopes(
      mixinHasRelationships(
        mixinHasTimestamps(
          mixinHidesAttributes(mixinGuardsAttributes(BaseModel))
        )
      )
    )
  )
  ...
  fill(attributes) {
    ...
    for (const [key, value] of Object.entries(
      this._fillableFromArray(attributes)
    )) {
  ...
  finishSave(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        this.isDirty() &&
        ((_a = options['touch']) !== null && _a !== void 0 ? _a : true)
      ) {
  ...
  toArray() {
    return Object.assign(
      Object.assign({}, this.attributesToArray()),
  ...
  refresh() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const result = yield this._setKeysForSelectQuery(
  ...
  resolveRouteBinding(value, field = null) {
    return this.where(
      field !== null && field !== void 0 ? field : this.getRouteKeyName(),
      value
    ).first()
  }
