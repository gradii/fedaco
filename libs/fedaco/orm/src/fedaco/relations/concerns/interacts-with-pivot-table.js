  ...
  return class _Self extends base {
    ...
    toggle(ids, touch = true) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const detach = Object.values(intersection(yield this.newPivotQuery().pluck(this.relatedPivotKey), Object.keys(records)));
        if (detach.length > 0) {
        ...
        if (touch && (changes['attached'].length ||
    ...
    syncWithPivotValues(ids, values, detaching = true) {
      return this.sync(mapWithKeys(this._parseIds(ids), id => {
        return { id: values };
      }), detaching);
    }
    ...
    updateExistingPivot(id, attributes, touch = true) {
      ...
      const updated = this.newPivotStatementForId(this._parseId(id)).update(this._castAttributes(attributes));
      if (touch) {
        this.touchIfTouching();
      }
      return updated;
    ...
    attach(id, attributes = {}, touch = true) {
      return __awaiter(this, void 0, void 0, function* () {
        if (this._using) {
          ...
          yield this.newPivotStatement().insert(this._formatAttachRecords(this._parseIds(id), attributes));
        }
        if (touch) {
          this.touchIfTouching();
        }
    ...
    _formatAttachRecord(key, value, attributes, hasTimestamps) {
      ...
      return Object.assign(Object.assign({}, this._baseAttachRecord(id, hasTimestamps)), this._castAttributes(attributes));
    }
    ...
    _getCurrentlyAttachedPivots() {
      return __awaiter(this, void 0, void 0, function* () {
        return (yield this.newPivotQuery().get()).map(record => {
          ...
          const pivot = clazz.fromRawAttributes(this.parent, record, this.getTable(), true);
    ...
    _parseId(value) {
      return value instanceof BaseModel ? value.getAttribute(this._relatedKey) : value;
    }
