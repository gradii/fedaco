...
export function mixinAsPivot(base) {
  return class _Self extends base {
    ...
    hasTimestampAttributes(attributes = null) {
      return this.getCreatedAtColumn() in (attributes !== null && attributes !== void 0 ? attributes : this.attributes);
    }
    ...
    getQueueableId() {
      ...
      return `${this._foreignKey}:${this.getAttribute(this._foreignKey)}:${this._relatedKey}:${this.getAttribute(this._relatedKey)}`;
    }
