...
export const BelongsToManyColumn = makePropDecorator('Fedaco:BelongsToMany', (p) => (Object.assign({
  isRelation: true, type: 'BelongsToMany', _getRelation: function(m, relation) {
    ...
    const r = new BelongsToMany(instance.newQuery(), m, table, foreignPivotKey, relatedPivotKey, p.parentKey || m.getKeyName(), p.relatedKey || instance.getKeyName(), relation);
    if (p.onQuery) {
      p.onQuery(r);
    }
    return r;
