...
function morphInstanceTo(m, target, name, type, id, ownerKey) {
  ...
  return new MorphTo(instance.newQuery(), m, id, ownerKey !== null && ownerKey !== void 0 ? ownerKey : instance.getKeyName(), type, name);
}

export const MorphEagerToColumn = makePropDecorator('Fedaco:MorphToColumn', (p) => (Object.assign({
  isRelation: true, type: 'MorphTo', _getRelation: function(m, relation) {
