...
export const HasManyColumn = makePropDecorator('Fedaco:HasManyColumn', (p) => (Object.assign({
  isRelation: true, type: 'HasMany', _getRelation: function(m) {
    ...
    const r = new HasMany(instance.newQuery(), m, `${instance.getTable()}.${foreignKey}`, localKey);
    if (p.onQuery) {
      p.onQuery(r);
    }
    return r;
