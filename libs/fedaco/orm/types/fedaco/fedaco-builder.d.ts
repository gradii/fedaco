...
export interface FedacoBuilder<T extends Model = Model>
    ...
    withGlobalScope(
        identifier: string,
        scope: Scope | FedacoBuilderCallBack
    ): this;
    ...
    findOrFail<P extends any[] | any>(
        id: P,
        columns?: any[]
    ): Promise<P extends any[] ? T[] : T>;
    ...
    firstOr(
        ...
        callback?: FedacoBuilderCallBack | null
    ): Promise<T>;
    ...
    _eagerLoadRelation(
        models: any[],
        name: string,
        constraints: FedacoBuilderCallBack
    ): Promise<T[]>;
    ...
    _addNestedWiths(
        name: string,
        results: Record<string, FedacoBuilderCallBack>
    ): Record<string, FedacoBuilderCallBack>;
...
declare const FedacoBuilder_base: import('./mixins/guards-attributes').GuardsAttributesCtor<unknown> &
    import('./mixins/queries-relationships').QueriesRelationShipsCtor &
    Constructor<
        Omit<BuildQueriesCtor & ForwardCallToQueryBuilderCtor, 'first'>
    >;
export declare class FedacoBuilder<
    T extends Model = Model
> extends FedacoBuilder_base {
