...
export declare type QueriesRelationShipsCtor =
    Constructor<QueriesRelationShips>;
export declare function mixinQueriesRelationShips<T extends Constructor<any>>(
    base: T
): QueriesRelationShipsCtor & T;
