...
export interface QueriesRelationShips {
    ...
    hasMorph(relation: MorphTo | string, types: string[], operator?: string, count?: number, conjunction?: string, callback?: ((q: FedacoBuilder) => void) | null): this;
    ...
    doesntHaveMorph(relation: MorphTo | string, types: string[], conjunction?: string, callback?: ((q: FedacoBuilder) => void)): this;
    ...
    whereHasMorph(relation: MorphTo | string, types: string[], callback?: ((q: FedacoBuilder) => void) | null, operator?: string, count?: number): this;
    whereHasMorph(relation: MorphTo | string, types: string[], callback?: Function | null, operator?: string, count?: number): this;
    orWhereHasMorph(relation: MorphTo | string, types: string[], callback?: ((q: FedacoBuilder) => void) | null, operator?: string, count?: number): this;
    orWhereHasMorph(relation: MorphTo | string, types: string[], callback?: Function | null, operator?: string, count?: number): this;
    whereDoesntHaveMorph(relation: MorphTo | string, types: string[], callback?: ((q: FedacoBuilder) => void) | null): this;
    whereDoesntHaveMorph(relation: MorphTo | string, types: string[], callback?: Function | null): this;
    orWhereDoesntHaveMorph(relation: MorphTo | string, types: string[], callback?: ((q: FedacoBuilder) => void) | null): this;
