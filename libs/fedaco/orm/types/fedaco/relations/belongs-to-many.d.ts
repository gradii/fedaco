...
export interface BelongsToMany
    extends InteractsWithDictionary,
        InteractsWithPivotTable,
        Constructor<Relation> {}
declare const BelongsToMany_base: import('./concerns/interacts-with-dictionary').InteractsWithDictionaryCtor &
    (new (...args: any[]) => InteractsWithPivotTable) &
    typeof Relation;
export declare class BelongsToMany extends BelongsToMany_base {
    ...
    withPivotValue(
        column: string | any[] | object,
        value?: any
    ): FedacoBuilder<Model> | this;
