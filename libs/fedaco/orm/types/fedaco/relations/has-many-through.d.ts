...
export interface HasManyThrough
...
declare const HasManyThrough_base: import('./concerns/interacts-with-dictionary').InteractsWithDictionaryCtor &
    typeof Relation;
