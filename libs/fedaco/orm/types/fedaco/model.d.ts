...
export declare function onWriteConnection(
    clazz: typeof Model
): FedacoBuilder<Model>;
...
export declare function withRelations(
    clazz: typeof Model,
    ...relations: string[]
): FedacoBuilder<Model>;
...
export declare namespace Model {
    ...
    function addGlobalScope(
        scope: string,
        implementation: Scope | ((q: QueryBuilder) => void)
    ): void;
    function addGlobalScope(
        scope: string,
    ...
    new (...args: any[]): {
        ...
        _registerObserver(
            clazz: any &
                ...
                (new (...args: any[]) => HasRelationships) &
                import('./mixins/has-timestamps').HasTimestampsCtor &
                (new (...args: any[]) => HidesAttributes) &
                import('./mixins/guards-attributes').GuardsAttributesCtor<unknown> &
                typeof BaseModel
        ): void;
...
export declare class Model extends Model_base {
    ...
    save(options?: { touch?: boolean }): Promise<boolean>;
    saveOrFail(options?: any): Promise<any>;
    protected finishSave(options: { touch?: boolean }): Promise<void>;
    ...
    static createQuery<T extends typeof Model>(
        this: T
    ): FedacoBuilder<InstanceType<T>>;
    ...
    protected resolveChildRouteBindingQuery(
        childType: string,
        value: any,
        field: string | null
    ): any;
