...
export declare function withTrashed(
    withTrashed?: boolean
): (builder: FedacoBuilder) => FedacoBuilder<Model>;
export declare function withoutTrashed(): (
    builder: FedacoBuilder
) => FedacoBuilder<Model>;
export declare function onlyTrashed(): (
    builder: FedacoBuilder
) => FedacoBuilder<Model>;
