...
export declare class MysqlConnector extends Connector implements ConnectorInterface {
    connect(config: any): Promise<MysqlWrappedConnection>;
    createConnection(database: string, config: any, options: any): Promise<MysqlWrappedConnection>;
    ...
    protected configureTimezone(connection: MysqlWrappedConnection, config: any): Promise<void>;
