...
declare const Builder_base: import("./mixins/join").QueryBuilderJoinCtor & import("./mixins/order-by").QueryBuilderOrderByCtor & import("./mixins/group-by").QueryBuilderGroupByCtor & import("./mixins/having").QueryBuilderHavingCtor & import("./mixins/limit-offset").QueryBuilderLimitOffsetCtor & import("./mixins/union").QueryBuilderUnionCtor & import("./mixins/where-json").WhereJsonCtor & import("./mixins/where-date").WhereDateCtor & import("./mixins/aggregate").QueryBuilderAggregateCtor & import("./mixins/where-predicate").WherePredicateCtor & import("./mixins/where-common").WhereCommonCtor & import("./mixins/build-query").BuildQueriesCtor & {
    new (): {};
};
