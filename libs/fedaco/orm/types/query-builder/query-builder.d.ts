...
export declare class QueryBuilder extends Builder {
    ...
    _prepareValueAndOperator<P = any>(
        value: P,
        operator: string,
        useDefault?: boolean
    ): [P, string];
    ...
    addSelect(
        columns: Array<string | RawExpression | ColumnReferenceExpression>
    ): this;
    distinct(...args: (string | boolean)[]): this;
    insertGetId(values: any, sequence?: string): Promise<number>;
    from(
        table: Function | QueryBuilder | RawExpression | string,
        as?: string
    ): this;
    ...
    isQueryable(
        value: QueryBuilder | FedacoBuilder | Relation | Function | any
    ): value is QueryBuilder | Function;
...
export declare class JoinClauseBuilder extends QueryBuilder {
    ...
    orOn(
        first: ((query?: JoinClauseBuilder) => any) | string,
        operator?: string,
        second?: string
    ): this;
