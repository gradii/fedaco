...
export interface QueryBuilderWhereCommon {
    ...
    where(left: string, right: ((q: this) => void) | RawExpression | boolean | string | number | Array<string | number>): this;
    where(left: string, operator: string, right: ((q: this) => void) | RawExpression | boolean | string | number | Array<string | number>): this;
    where(left: string, operator: string, right: ((q: this) => void) | RawExpression | boolean | string | number | Array<string | number>, conjunction: 'and' | 'or' | string): this;
    where(left: ((q: this) => void) | string | any[], operator: string, right: ((q: this) => void) | RawExpression | boolean | string | number | Array<string | number>, conjunction: 'and' | 'or' | string): this;
