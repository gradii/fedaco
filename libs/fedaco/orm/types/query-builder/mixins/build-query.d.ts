...
export interface BuildQueries {
    ...
    first(columns?: any[] | string): Promise<Model | any | null>;
    when(
        condition: boolean,
        callback: (q: this, condition: boolean) => any,
...
export declare function mixinBuildQueries<T extends Constructor<any>>(
    base: T
): BuildQueriesCtor & T;
