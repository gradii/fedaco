...
export interface QueryBuilderJoin {
    ...
    joinWhere(table: string, first: ((q: JoinClauseBuilder) => void) | string, operator: string, second: string, type?: string): this;
    joinSub(query: ((q: JoinClauseBuilder) => void) | QueryBuilder | string, as: string, first: Function | string, operator?: string, second?: string | number, type?: string, where?: boolean): this;
    ...
    leftJoinSub(query: ((q: JoinClauseBuilder) => void) | QueryBuilder | string, as: string, first: Function | string, operator?: string, second?: string): this;
    ...
    rightJoinSub(query: ((q: JoinClauseBuilder) => void) | QueryBuilder | string, as: string, first: Function | string, operator?: string, second?: string): this;
