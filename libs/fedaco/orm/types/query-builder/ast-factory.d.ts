...
export declare function bindingVariable(
    value: string | number | boolean | RawExpression,
    type?: string
): RawExpression | BindingVariable;
export declare function rawSqlBindings(
    value: string | number | boolean,
    bindings: any[],
    type?: string
): RawBindingExpression;
export declare function createIdentifier(
    identifier: string | ForwardRefFn<string>
): Identifier;
export declare function createStringLiteral(
    identifier: string | ForwardRefFn<string>
): StringLiteralExpression;
export declare function createTableColumn(
    table: FromTable | Identifier,
    column: string
): ColumnReferenceExpression;
export declare function createColumnReferenceExpression(
    column: string | ColumnReferenceExpression
): ColumnReferenceExpression;
