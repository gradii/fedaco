...
export declare class PostgresQueryGrammar extends QueryGrammar implements GrammarInterface {
    ...
    compileInsertGetId(query: QueryBuilder, values: any[], sequence?: string): string;
