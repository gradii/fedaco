...
export declare class SelectClause extends SqlNode {
    selectExpressions: Array<ColumnReferenceExpression | SelectScalarExpression | RawExpression | RawBindingExpression>;
    distinct: boolean | any[];
    constructor(selectExpressions?: Array<ColumnReferenceExpression | SelectScalarExpression | RawExpression | RawBindingExpression>, distinct?: boolean | any[]);
